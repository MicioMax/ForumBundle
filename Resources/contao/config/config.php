...
(
    ...
    (
        ...
        'email_subject'        => array('admin_email', 'responsible_username','threadname', 'forumname'),
        'email_text'           => array('user_name', 'threadname','forumname', 'responsible_username', 'admin_email', 'link', 'unsubscribe_link', 'unsubscribe_all_link',),
        'email_html'           => array('user_name', 'threadname','forumname', 'responsible_username', 'admin_email', 'link', 'unsubscribe_link', 'unsubscribe_all_link',),
        ...
        'file_content'           => array('user_name', 'threadname','forumname', 'responsible_username', 'admin_email', 'link', 'unsubscribe_link', 'unsubscribe_all_link',),
    ),
