...
(
    ...
    (
        ...
        'email_text'           => array('user_name', 'responsible_username', 'admin_email', 'text', 'subject',),
        'email_html'           => array('user_name', 'responsible_username', 'admin_email', 'html', 'subject',),
        'email_sender_name'    => array('responsible_username'),
        'email_sender_address' => array('admin_email'),
        'email_recipient_cc'   => array('admin_email'),
        'email_recipient_bcc'  => array('admin_email'),
        'email_replyTo'        => array('admin_email'),
        'file_content'           => array('user_name', 'responsible_username', 'admin_email', 'link', 'subject', 'text', 'html',),
    )
);
